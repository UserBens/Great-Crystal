...
class EtcMail extends Mailable
{
    ...
    {
        $file = [
            Attachment::fromData(fn () => $this->pdf->output(), 'Others' . date('F Y', strtotime($this->mailData['bill'][0]->created_at)) . ' ' . $this->mailData['student']->name)
