                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select name="gradeId" class="form-control" required>
                                                    ...
                                                    <option selected {{ old('grade_id') ? '' : 'disabled' }}
                                                        value="{{ old('grade_id') ? old('grade_id') : '' }}">
                                                        {{ old('grade_id') ? $selectedName : '--- SELECT GRADE ---' }}
                                                    </option>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group date" id="reservationdate" data-target-input="nearest">
                                                <input name="studentDate_birth" type="text" class="form-control "
                                                    placeholder="dd/mm/yyyy" data-target="#reservationdate"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input name="studentPlace_of_issue" type="text" class="form-control"
                                                id="studentPlace_of_issue" value="{{ old('place_of_issue') }}"
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group date" id="reservationdateStudentDateReg"
                                                ...
                                                <input name="created_at" type="text" class="form-control "
                                                    placeholder="dd/mm/yyyy" data-target="#reservationdateStudentDateReg"
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group date" id="reservationdateStudentDateExp"
                                                data-target-input="nearest">
                                                <input name="studentDate_exp" type="text" class="form-control "
                                                    placeholder="dd/mm/yyyy" data-target="#reservationdateStudentDateExp"
                                                    data-inputmask-alias="datetime"
                                                    data-inputmask-inputformat="dd/mm/yyyy" data-mask
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input name="fatherId_or_passport" type="text" class="form-control"
                                                ...
                                                value="{{ old('father_id_or_passport') }}" required>
                                            @if ($errors->any())
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select name="fatherReligion" class="form-control" required>
                                                ...
                                                <option selected {{ old('father_religion') ? '' : 'disabled' }}>
                                                    {{ old('father_religion') ? old('father_religion') : '--- SELECT RELIGION ---' }}
                                                </option>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input name="fatherPlace_birth" type="text" class="form-control"
                                                ...
                                                value="{{ old('father_place_birth') }}" required>
                                            @if ($errors->any())
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="input-group date" id="reservationFatherBirthDate"
                                                data-target-input="nearest">
                                                <input name="fatherBirth_date" type="text" class="form-control "
                                                    placeholder="dd/mm/yyyy" data-target="#reservationFatherBirthDate"
                                                    data-inputmask-alias="datetime"
                                                    data-inputmask-inputformat="dd/mm/yyyy" data-mask required
                                                    value="{{ old('father_date_birth') ? date('d-m-Y', strtotime(old('father_date_birth'))) : '' }}" />
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input name="fatherNationality" type="text" class="form-control"
                                                ...
                                                value="{{ old('father_nationality') }}" required>
                                            @if ($errors->any())
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-6">
                                            ...
                                            <input name="fatherCompany_address" type="text" class="form-control"
                                                ...
                                                value="{{ old('father_company_address') }}">
                                            @if ($errors->any())
                                ...
                                <div class="card-body">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input name="motherId_or_passport" type="text" class="form-control"
                                                ...
                                                value="{{ old('mother_id_or_passport') }}" required>
                                            @if ($errors->any())
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select name="motherReligion" class="form-control" required>
                                                ...
                                                <option selected {{ old('mother_religion') ? '' : 'disabled' }}>
                                                    {{ old('mother_religion') ? old('mother_religion') : '--- SELECT RELIGION ---' }}
                                                </option>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input name="motherPlace_birth" type="text" class="form-control"
                                                ...
                                                value="{{ old('mother_place_birth') }}" required>
                                            @if ($errors->any())
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="input-group date" id="reservationMotherBirthDate"
                                                data-target-input="nearest">
                                                <input name="motherBirth_date" type="text" class="form-control "
                                                    placeholder="dd/mm/yyyy" data-target="#reservationMotherBirthDate"
                                                    data-inputmask-alias="datetime"
                                                    data-inputmask-inputformat="dd/mm/yyyy" data-mask
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input name="motherNationality" type="text" class="form-control"
                                                ...
                                                value="{{ old('mother_nationality') }}" required>
                                            @if ($errors->any())
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="motherCompany_name" type="text" class="form-control"
                                            value="{{ old('mother_company_name') }}" id="motherCompany_name"
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-6">
                                            ...
                                            <input name="motherCompany_address" type="text" class="form-control"
                                                ...
                                                value="{{ old('mother_company_address') }}">
                                            @if ($errors->any())
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="motherHome_address" type="text" class="form-control"
                                            ...
                                            value="{{ old('mother_home_address') }}" required>
                                        @if ($errors->any())
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input name="motherEmail" type="email" class="form-control"
                                                    placeholder="Enter father's email" value="{{ old('mother_email') }}"
                                                    required>
                                                @if ($errors->any())
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input name="brotherOrSisterName1" type="text" class="form-control"
                                                ...
                                                value="{{ old('brotherOrSisterName1') }}">
                                            @if ($errors->any())
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input name="brotherOrSisterGrade1" type="text" class="form-control"
                                                ...
                                                value="{{ old('brotherOrSisterGrade1') }}">
                                            @if ($errors->any())
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input name="brotherOrSisterName2" type="text" class="form-control"
                                                ...
                                                value="{{ old('brotherOrSisterName2') }}">
                                            @if ($errors->any())
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input name="brotherOrSisterGrade2" type="text" class="form-control"
                                                ...
                                                value="{{ old('brotherOrSisterGrade2') }}">
                                            @if ($errors->any())
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-4">
                                            ...
                                            <input name="brotherOrSisterName3" type="text" class="form-control"
                                                ...
                                                value="{{ old('brotherOrSisterName3') }}">
                                            @if ($errors->any())
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input name="brotherOrSisterGrade3" type="text" class="form-control"
                                                ...
                                                value="{{ old('brotherOrSisterGrade3') }}">
                                            @if ($errors->any())
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-4">
                                            ...
                                            <input name="brotherOrSisterName4" type="text" class="form-control"
                                                ...
                                                value="{{ old('brotherOrSisterName4') }}">
                                            @if ($errors->any())
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input name="brotherOrSisterGrade4" type="text" class="form-control"
                                                ...
                                                value="{{ old('brotherOrSisterGrade4') }}">
                                            @if ($errors->any())
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-4">
                                            ...
                                            <input name="brotherOrSisterName5" type="text" class="form-control"
                                                ...
                                                value="{{ old('brotherOrSisterName5') }}">
                                            @if ($errors->any())
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input name="brotherOrSisterGrade5" type="text" class="form-control"
                                                ...
                                                value="{{ old('brotherOrSisterGrade5') }}">
                                            @if ($errors->any())
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input name="amount" type="text" class="form-control" id="amount"
                                                    placeholder="Enter amount capital fee"
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input name="dp" type="text" class="form-control" id="dp"
                                                    placeholder="Enter done payment"
                                                    value="{{ old('dp') ? number_format(old('dp'), 0, ',', '.') : '' }}">
                                            </div>
                                            @if ($errors->any())
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input name="installment" type="number" class="form-control"
                                                id="installment" placeholder="(Cicilan)"
                                                value="{{ old('installment') }}" max="12" min="2">
                                        </div>
                                    </div>


                                    <span role="button" onclick="MonthlyFee()"
                                        class="text-primary {{ $className ? '' : 'd-none' }}" id="btnMonthlyFee">Add
                                        monthly fee</span>
                                </div>
                            </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input name="amount_monthly_fee" type="text" class="form-control"
                                                    id="amount_monthly_fee" placeholder="Enter amount monthly fee"
                                                    value="{{ old('amount_monthly_fee') ? number_format(old('amount_monthly_fee'), 0, ',', '.') : '' }}">
                                            </div>
                                            @if ($errors->any())
