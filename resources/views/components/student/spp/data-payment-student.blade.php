                ...
                <div class="col-md-10 offset-md-1">
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <select name="grade" class="form-control text-center" required>
                                    <option {{ $selectedGrade === 'all' ? 'selected' : '' }} value="all">-- All Grades --
                                    </option>
                                    @foreach ($grade as $el)
                                        <option {{ $selectedGrade == $el->id ? 'selected' : '' }}
                        ...
                        <div class="col-2">
                            <div class="form-group">
                                ...
                                <select name="sort" class="form-control">
                                    <option value="desc" {{ $selectedOrder === 'desc' ? 'selected' : '' }}>Descending
                                    </option>
                                    <option value="asc" {{ $selectedOrder === 'asc' ? 'selected' : '' }}>Ascending
                                    </option>
                                </select>
                            </div>
                        </div>
                        <div class="col-2">
                            <div class="form-group">
                                ...
                                <select name="order" class="form-control">
                                    ...
                                    <option {{ $selectedSort === 'grade_id' ? 'selected' : '' }} value="grade_id">Grade
                                    </option>
                                </select>
                    ...
                    <div class="form-group">
                        <div class="input-group input-group-lg">
                            <input name="search" value="{{ $form ? $form->search : '' }}" type="search"
                                    ...
                                    <td>
                                        <a>
                                            @if ($el->spp_student)
                                                ...
                                                IDR
                                                {{ number_format($el->spp_student->amount - ($el->spp_student->amount * $el->spp_student->discount) / 100, 0, ',', '.') }}
                                                <br>
