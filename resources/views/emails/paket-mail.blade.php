                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="left"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <h1
                                                                            style="margin: 0; font-size: 24px; line-height: normal; font-weight: 700;">
                                                                            Pemberitahuan Tagihan Biaya Kegiatan School
                                                                            Year
                                                                            @php
                                                                                $currentYear = date('Y');
                                                                            ...
                                                                            @endphp
                                                                            {{ $isInstallment ? 'cicilan Package ' . date('F Y', strtotime($mailData['bill'][0]->deadline_invoice)) : $schoolYear }}
                                                                        </h1>
                                                                    </div>
                                                                </td>
                                                                ...
                                                                <td align="left"
                                                                    ...
                                                                    @if ($mailData['past_due'])
                                                                        <div
                                                                            ...
                                                                            @if ($mailData['change'])
                                                                                <p style="margin: 0;">
                                                                                    {{ 'Kami informasikan biaya kegiatan untuk menunjang proses pembelajaran ' . $mailData['student']->name . ' sudah diubah dengan cicilan ' . $mailData['bill'][0]->installment . 'x ' . 'dan sudah melewati jatuh tempo.' }}
