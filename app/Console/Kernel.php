...
class Kernel extends ConsoleKernel
{
    ...
    protected function schedule(Schedule $schedule): void
    {
        ...
        $schedule->command('spp:cron')->monthlyOn(6, '13:28')->timezone('Asia/Jakarta')->emailOutputOnFailure($email_logging);
        ...
        $schedule->command('book:cron')->dailyAt('10:38')->timezone('Asia/Jakarta')->emailOutputOnFailure($email_logging);
        ...
        $schedule->command('paket:cron')->dailyAt('12:01')->timezone('Asia/Jakarta')->emailOutputOnFailure($email_logging);
